      ...
      try{
        ...
        results.forEach(p => {
          ...
          if(!pusheds.includes(tokenId)){
            ...
            if(p.auction.currentPriceUSD <= 250){
      ...
      try {
          ...
          results.forEach(p => {
            ...
            if(!pusheds.includes(tokenId)){
              ...
              if(p.auction.currentPriceUSD <= 315){
                that.postTeleMessage(axieName, breedCount, currentPrice, currentPriceUSD, tokenId);
                pusheds.push(tokenId);
              }
            }
